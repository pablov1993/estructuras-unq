...
intersection (Set list) (Set list') = Set (doIntersection list list')

doIntersection :: Eq a => [a] -> [a] -> [a]
doIntersection [] list = []
doIntersection (x:xs) list = 
    if pertenece x list 
        then x : (doIntersection xs list)
        else doIntersection xs list
